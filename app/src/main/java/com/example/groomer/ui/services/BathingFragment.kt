 ...
 * Use the [BathingFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class BathingFragment : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_bathing, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment BathingFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            BathingFragment().apply {
