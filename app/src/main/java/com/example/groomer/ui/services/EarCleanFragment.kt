 ...
 * Use the [EarCleanFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class EarCleanFragment : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_ear_clean, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment EarCleanFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            EarCleanFragment().apply {
