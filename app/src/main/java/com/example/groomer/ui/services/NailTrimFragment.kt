 ...
 * Use the [NailTrimFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class NailTrimFragment : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_nail_trim, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment NailTrimFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            NailTrimFragment().apply {
